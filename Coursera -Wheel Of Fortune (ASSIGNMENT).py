...
class WOFHumanPlayer(WOFPlayer):
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        guessed = input("Guess a letter, phrase, or type 'exit' or 'pass':")
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        ...
        if x == []:
            ...
            if smartMove == True:
                ...
                while i >= 0:
                    if self.SORTED_FREQUENCIES[i] in x:
...
computer_players = [WOFComputerPlayer('Computer {}'.format(i+1), difficulty=11) for i in range(num_computer)]
